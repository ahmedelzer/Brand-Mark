        ...
        <div className={contactUsStyles.contentWrapper}>
          ...
          <div className={contactUsStyles.requestWrapper}>
            <div className={contactUsStyles.contactInfoWrapper}>
              <div className={contactUsStyles.infoBlock}>
                <div className={contactUsStyles.infoIconWrapper}>
                  ...
                  <div className={contactUsStyles.infoTextWrapper}>
                    <p className={contactUsStyles.infoTitle}>
                      {localization.contact.support.title}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.support.email}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.support.phone}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={contactUsStyles.infoBlock}>
                <div className={contactUsStyles.infoIconWrapper}>
                  ...
                  <div className={contactUsStyles.infoTextWrapper}>
                    <p className={contactUsStyles.infoTitle}>
                      {localization.contact.sales.title}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
              ...
              <div className={contactUsStyles.infoBlock}>
                <div className={contactUsStyles.infoIconWrapper}>
                  ...
                  <div className={contactUsStyles.infoTextWrapper}>
                    <p className={contactUsStyles.infoTitle}>
                      {localization.contact.press.title}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.press.email}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.press.phone}
                    </p>
                  </div>
                </div>
              </div>
              <div className={contactUsStyles.infoBlock}>
                <div className={contactUsStyles.infoIconWrapper}>
                  ...
                  <div className={contactUsStyles.infoTextWrapper}>
                    <p className={contactUsStyles.infoTitle}>
                      {localization.contact.bugReport.title}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.bugReport.email}
                    </p>
                    <p className={contactUsStyles.infoDetails}>
                      {localization.contact.bugReport.phone}
                    </p>
                  </div>
                </div>
              </div>
