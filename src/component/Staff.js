    ...
    <div class="container my-24 mx-auto md:px-6">
      <section class="mb-32 text-center">
        <h2 class="mb-32 text-3xl font-bold">
          Meet the <u class=" text-accent">team</u>
        </h2>

        <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
          <div class="mb-24 md:mb-0">
            <div class="block h-full rounded-lg card-shadow bg-card">
              ...
              <div class="p-6">
                <h5 class="mb-4 text-lg font-bold text-accent">Marta Smith</h5>
                ...
                <ul class="mx-auto flex list-inside justify-center">
                  <a href="#!" class="px-2">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      class="h-4 w-4  dark:text-primary-400"
                    >
                      <path
                        fill="currentColor"
